                               ...
                               char* szErrOut, int nErrMax)
{
    ...
    _snprintf(szOutDir, sizeof(szOutDir), "%s\\LLHD_Screenshots", szDocDir);
    ...
    _snprintf(szFile, sizeof(szFile),
        "%s\\LLHD_%04d%02d%02d_%02d%02d%02d.png",
        szOutDir,
...
static void DoSaveScreenshot(HWND hWnd)
{
    ...
    if (SaveScreenshotPNG(hWnd, szPath, MAX_PATH, szErr, sizeof(szErr))) {
        ...
        int nRet = MessageBoxA(hWnd, szMsg, "LLHD Monitor — Screenshot Saved",
        ...
        MessageBoxA(hWnd, szMsg, "LLHD Monitor — Screenshot Error", MB_OK | MB_ICONERROR);
    }
}
...
void TrayIcon_ShowContextMenu(HWND hWnd)
{
    ...
    AppendMenuA(hMenu, MF_STRING, IDM_SCREENSHOT,   "Save Screenshot");
...
static void CreateMenuBar(HWND hWnd)
{
    ...
    AppendMenuA(hHelp, MF_STRING, IDM_ABOUT, "About LLHD Monitor");
